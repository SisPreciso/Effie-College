                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                            <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">Por motivos imprevistos, hemos tenido que cambiar el horario de la reunión virtual de briefing con <span style="font-weight: bold">{{ $brand }}</span> a mañana, miércoles 20 de abril, a las {{ $schedule }}. Nuestras disculpas por el inconveniente, ¡sigue adelante con tu postulación, éxitos!</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding-right:20px;padding-left:20px">
                            <p style="color:#808080;margin:0;padding-bottom:5px;font-size:16px">Saludos,</p>
