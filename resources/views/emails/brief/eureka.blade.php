                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                            <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">Por motivos imprevistos, hemos tenido que cambiar el horario de la reunión virtual de briefing con <span style="font-weight: bold">{{ $brand }}</span> a mañana, viernes 22 de abril, a las {{ $schedule }}. Nuestras disculpas por el inconveniente, por el retraso de la reunión, la fecha límite para que entreguen su trabajo se aplazará hasta el 17 de mayo</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-right:20px;padding-left:20px">
                            <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">Pueden ingresar a la reunión con este enlace: {{ $link }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-right:20px;padding-left:20px">
                            <p style="color:#808080;margin:0;padding-bottom:5px;font-size:16px">¡Sigue adelante con tu postulación, éxitos!</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding-right:20px;padding-left:20px">
                            ...
                            <p style="color:#cbb27c;margin:0;font-size:16px">Coordinadora de Effie<sup>®</sup> College Perú
                            </p>
                        </td>
                    </tr>
                </tbody>
