...
<main>
    <div style="content:'';width:70%;background-image:url('https://effie-college.effie-peru.com/images/fondo.svg');background-repeat:no-repeat;background-position-x:right;background-position-y:bottom;opacity:0.5;position:absolute;top:0;bottom:0;right:0;z-index:-1"></div>
            ...
            <tbody>
                    ...
                    <td style="padding-left:20px;padding-right:20px">
                        <table width="100%" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    <td>
                                        <p style="color:#cbb27c;margin:0;padding-top:10px;padding-bottom:10px;font-size:16px"><b>¡Hola, Equipo {{ $team }}!</b></p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                        <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">Les contamos que ya pueden acceder a la información de la marca Mibanco en la plataforma de Effie College. Asegúrense de revisarla al detalle para que puedan desarrollar el caso perfectamente. No se olviden que la fecha límite para enviar el formulario de participación es el jueves 13 de mayo.</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding-right:20px;padding-left:20px">
                        ...
                        <p style="color:#cbb27c;margin:0;font-size:16px">Coordinadora Effie<sup>®</sup> College Perú</p>
                    </td>
                </tr>
            </tbody>
        </table>
