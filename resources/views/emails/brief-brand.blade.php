        ...
        <table>
            ...
            <tr>
                <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                    ...
                    ¡Es hora de poner manos a la obra! Adjunto a este correo <b>encontrarán el brief de la marca {{$brand}}</b>
                    con la que estarán trabajando en este Effie College 2024.
                    </p>
                    
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                    Este documento es fundamental para desarrollar su propuesta estratégica, así que les recomendamos revisarlo 
                    detenidamente antes de la reunión virtual de briefing para que puedan resolver sus consultas con el representante de la marca. Por otro lado, tengan presente que toda esta información es estrictamente confidencial.
                    </p>
                    
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        Para descargar el documento dando clic en el <b>siguiente enlace: {{$link}}</b> 
                    </p>

                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                    ¡Estamos seguros de que pondrán todo su talento y creatividad en esta etapa crucial!
                    </p>
