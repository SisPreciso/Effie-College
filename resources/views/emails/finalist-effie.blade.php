        ...
        <table>
            ...
            <tr>
                <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                    ...
                    ¡FELICIDADES! Han <b>avanzado a la etapa de finalistas </b> de Effie College 2024 con la marca {{ $brand }}. 
                    Su dedicación y esfuerzo han dado frutos, y eso merece un gran reconocimiento.
                    </p>
                    
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                    Pronto recibirán un correo indicándoles la hora y el lugar de la presentación ante el jurado final, 
                    la cual es presencial, vayan preparándose.
                    </p>

                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                       Ahora están a un paso de la etapa final: la decisión del jurado. 
                       Les deseamos todo el éxito en esta fase decisiva. ¡Sigan brillando!
                    </p>
            ...
            <tr>
                <td style="padding-right:20px;padding-left:20px">
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        Para acceder a su diploma <a href="documentos/Diplomas finalistas Effie College 2024 (E2024005).pdf">click aquí.</a>
                    </p>
