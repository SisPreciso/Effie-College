            ...
            <tr>
                <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        ¡Excelentes noticias! Hemos recibido su formulario de participación para Effie
                        College {{ now()->year }}.
                    </p>
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        Ahora, marquen sus calendarios: el {{ $finalistsDate }} anunciaremos a los finalistas en
                        nuestras redes sociales. ¡No podemos esperar para compartir los resultados!
                    </p>
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        Les deseamos mucho éxito y gracias por ser parte de esta emocionante competencia.
                    </p>
                </td>
            </tr>
            <tr>
