        ...
        <table>
            ...
            <tr>
                <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                    ...
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        Marquen sus calendarios: el {{ $finalistsDate }} se anunciará a los finalistas en las redes
                        sociales de Effie Perú.
                    </p>
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        Les deseamos mucho éxito y agradecemos su participación en este emocionante proceso.
                    </p>
                </td>
            </tr>
            <tr>
