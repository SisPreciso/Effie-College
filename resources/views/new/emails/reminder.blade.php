            ...
            <tr>
                <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        Les recordamos que deben activar su cuenta de Effie College, con una contraseña segura que
                        ustedes decidan, para empezar a conocer el formulario de participación y avanzar con el
                        desarrollo de sus casos.
                    </p>
                    <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">
                        ¡El tiempo ya está corriendo, a poner en marcha su creatividad y disciplina!
                    </p>
                </td>
            </tr>
            <tr>
                <td style="padding-right:20px;padding-left:20px">
                    ...
                    <p style="color:#cbb27c;margin:0;padding-bottom:20px;font-size:16px">
                        <b>El Equipo de Effie College</b>
                    </p>
                </td>
            </tr>
            </tbody>
